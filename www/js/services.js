...
.factory('loginFactory', ['$rootScope', '$auth', function($rootScope, $auth){
    return{
  ...
  password: $rootScope.password
        ...
        login: $auth.login($rootScope.user)
...
.factory('facebookAPIHandler', function(){
    return{
        
        /*
        App ID: 946778018721360
        App Secret: 67dcd0af03fb59cf6adb6366cdda8a4e
        */
